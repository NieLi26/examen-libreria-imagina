...
<template>
    <div class="footer bg-secondary text-white mb-3 mx-auto px-3 py-4 mb-3 border border-black border-2 rounded">
            ...
            <div class="redes-sociales">
                <ul>
                    ...
                    <li class="d-flex align-items-center gap-2">
                        ...
                        <a :href="redesSociales?.twitter">Twitter</a>
                    </li>
                    <li class="d-flex align-items-center gap-2">
                        <div class="icon">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a :href="redesSociales?.instagram">Instagram</a>
                    </li>
                </ul>
            </div>
            <div class="contactos">
...
export default {
    ...
    ( async () => {
      try {
        ...
        const { redesSociales, contacto } = data.paginaInicio;
        console.log(data);
